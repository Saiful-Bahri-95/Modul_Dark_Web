      ...
      lectures:[
        {
          ...
          body:`
            ...
            <div class="map">
              ...
              <div class="row"><span class="ix">03</span><div><h5>Mengakses Dark Net — Entry Points</h5><p>Memahami struktur web (clear/deep/dark) &amp; cara kerja onion service, menemukan hidden service lewat search &amp; direktori, memverifikasi keaslian serta mendeteksi tiruan/phishing — plus deep-dive anatomi v3 (descriptor, rendezvous, key blinding) dan bagaimana situs .onion sebenarnya dibongkar beserta pelajaran OPSEC-nya.</p></div></div>
              <div class="row"><span class="ix">04</span><div><h5>Praktik Lanjutan — Hands-On Labs</h5><p>9 lab praktik bertingkat: membangun &amp; mengeraskan TAILS, uji kebocoran, mengunjungi onion sah, PGP, OnionShare, menjalankan onion service sendiri, deteksi penipuan, membedah circuit &amp; stream isolation, hingga menyusun threat model + rencana OPSEC pribadi.</p></div></div>
